...
/// <summary>
/// Builds the placeholder graph: DedupeCheck -> (already applied? END : ScoreMatch) ->
/// (confidence >= threshold? auto-approve straight to RecordIfApproved : AskApproval) ->
/// RecordIfApproved -> END. Factored out of Program.cs so it can be built and run against
/// a <see cref="MockTelegramGateway"/> in tests without any real Telegram/network setup.
/// </summary>
